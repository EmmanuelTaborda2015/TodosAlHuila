...
public class Geolocalizacion extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Geolocalizacion.this.runOnUiThread(new Runnable() {
            public void run() {
                String id_dispositivo = Settings.Secure.getString(getApplication().getContentResolver(), Settings.Secure.ANDROID_ID);
                webResponseMarcador = new WS_Marcador(Geolocalizacion.this, "usuario", id_dispositivo, type);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu1) {
            ...
            Intent i = new Intent(Geolocalizacion.this, Categorias.class);
            startActivity(i);
            overridePendingTransition(0, 0);
            finish();
        } else if (id == R.id.menu3) {
            Intent i = new Intent(Geolocalizacion.this, Geolocalizacion.class);
            startActivity(i);
            overridePendingTransition(0, 0);
            finish();
        } else if (id == R.id.menu4) {
            Intent i = new Intent(Geolocalizacion.this, Agenda.class);
            startActivity(i);
            overridePendingTransition(0, 0);
            finish();
