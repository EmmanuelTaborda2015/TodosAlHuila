...
public class GeolocalizacionLogeo extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GeolocalizacionLogeo.this.runOnUiThread(new Runnable() {
            public void run() {
                String id_dispositivo = Settings.Secure.getString(getApplication().getContentResolver(), Settings.Secure.ANDROID_ID);
                webResponseMarcador = new WS_Marcador(GeolocalizacionLogeo.this, "usuario", id_dispositivo, type);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu1) {
            Intent i = new Intent(GeolocalizacionLogeo.this, Inicio.class );
            startActivity(i);
            overridePendingTransition(0, 0);
            finish();
        } else if (id == R.id.menu2) {
            Intent i = new Intent(GeolocalizacionLogeo.this, Categorias.class);
            startActivity(i);
            overridePendingTransition(0, 0);
            finish();
        } else if (id == R.id.menu3) {
            Intent i = new Intent(GeolocalizacionLogeo.this, GeolocalizacionLogeo.class);
            startActivity(i);
            overridePendingTransition(0, 0);
            finish();
        } else if (id == R.id.menu4) {
            Intent i = new Intent(GeolocalizacionLogeo.this, Agenda.class);
            startActivity(i);
            overridePendingTransition(0, 0);
            finish();
        ...
        public void run() {
            ...
            mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
                ...
                public void onInfoWindowClick(Marker marker) {
                    Intent i = new Intent(GeolocalizacionLogeo.this, Informacion.class);
