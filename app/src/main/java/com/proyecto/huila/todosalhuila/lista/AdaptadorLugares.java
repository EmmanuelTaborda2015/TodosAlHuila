...
public class AdaptadorLugares extends BaseAdapter {
    private ArrayList<TitularItemsLugares> listData;
    private LayoutInflater layoutInflater;

    public AdaptadorLugares(Context context, ArrayList<TitularItemsLugares> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TitularItemsLugares newsItem = listData.get(position);
