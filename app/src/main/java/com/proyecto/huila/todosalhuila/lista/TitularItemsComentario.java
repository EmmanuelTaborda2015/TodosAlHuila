...
public class TitularItemsComentario {
    ...
    public TitularItemsComentario(){}

    // Constructor con parámetros para inicializar el item

    public TitularItemsComentario(String _sitio, String _title, String _description, String _img){
