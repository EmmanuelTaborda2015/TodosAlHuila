...
public class ImageIndicatorViewUrl extends RelativeLayout {
	...
	public ImageIndicatorViewUrl(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.init(context);
	}

	public ImageIndicatorViewUrl(Context context) {
		super(context);
		this.init(context);
	}
	...
	private void init(Context context) {
		...
		this.refreshHandler = new ScrollIndicateHandler(ImageIndicatorViewUrl.this);
	}
	 ...
	 *            Drawable array
	 */
	public void setupLayoutByDrawable(final Bitmap resArray[]) {
		if (resArray == null)
	...
	private static class ScrollIndicateHandler extends Handler {
		private final WeakReference<ImageIndicatorViewUrl> scrollIndicateViewRef;

		public ScrollIndicateHandler(ImageIndicatorViewUrl scrollIndicateView) {
			this.scrollIndicateViewRef = new WeakReference<ImageIndicatorViewUrl>(
					scrollIndicateView);
		...
		public void handleMessage(Message msg) {
			...
			ImageIndicatorViewUrl scrollIndicateView = scrollIndicateViewRef.get();
